...
# mult by 2.5cm for square segment length
...
print("Camera Matrix")
print(cam_mtx)
np.save(camera_data_path + 'cam_mtx.npy', cam_mtx)

print("Distortion Coeff")
print(dist)
np.save(camera_data_path + 'dist.npy', dist)
...
newcam_mtx, roi = cv2.getOptimalNewCameraMatrix(cam_mtx, dist, (w, h), 1,
                                                (w, h))

print("Region of Interest")
print(roi)
np.save(camera_data_path + 'roi.npy', roi)

print("New Camera Matrix")
#print(newcam_mtx)
np.save(camera_data_path + 'newcam_mtx.npy', newcam_mtx)
print(np.load(camera_data_path + 'newcam_mtx.npy'))
